...
"""
FastAPI application for the Traffic Control Env Environment.

This module creates an HTTP server that exposes the TrafficControlEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn traffic_control_env.server.app:app --workers 4
    """
    import uvicorn
